...
**Latest briefing:** [2026-06-17](briefings/2026-06-17.md)
...
- **key-management** — [2026-06-12](briefings/2026-06-12.md), [2026-06-13](briefings/2026-06-13.md), [2026-06-17](briefings/2026-06-17.md)
...
- **supply-chain** — [2026-06-13](briefings/2026-06-13.md), [2026-06-17](briefings/2026-06-17.md)
...
- **Total briefings:** 6
- **Date range:** 2026-06-12 → 2026-06-17
- **Top 3 bug classes by briefing count:**
  1. `logic-error` — 5 briefings
  2. `bridge-dvn` — 3 briefings · `key-management` — 3 briefings *(tied)*
  3. `access-control` — 2 briefings · `flash-loan` — 2 briefings · `rounding` — 2 briefings · `supply-chain` — 2 briefings *(four-way tie)*
- **Cumulative $ at risk tracked:** ~$63.8M across all briefings
