...
**Latest briefing:** [2026-07-29](briefings/2026-07-29.md)
...
|------|-------|-----------|-------------|-----------|
| [2026-07-29](briefings/2026-07-29.md) | Blockaid confirms record $1.1B+ H1 2026 losses (DPRK $577M); GMX reentrancy post-mortems drop; Node.js HIGH patches | Blockaid H1 report ($1.1B+), GMX post-mortem ($42M recovered), BarnBridge $776K | reentrancy, logic-error, access-control, key-management | ~$0 new; ~$214M July MTD |
...
- **Total briefings:** 47
- **Date range:** 2026-06-12 → 2026-07-29 (48 days; 1 gap on 2026-06-26)
- **Top 3 bug classes by frequency:** `key-management` (34 briefings) · `logic-error` (31) · `access-control` (23)
